...
class OutRecommendationsHandlerTest {

	@InjectMocks
	private OutRecommendationsHandler handler;
	@Mock
	...
	void createUpdate() {
		...
		updateCat = getUpdate(json, "/catShelterOutRecommendations");
		updateDog = getUpdate(json, "/dogShelterOutRecommendations");
	}
	...
	void realizationButtonCatTest() {
		...
		assertEquals(updateCat.callbackQuery().data(), "/catShelterOutRecommendations");
	...
	void realizationButtonDogTest() {
		...
		assertEquals(updateDog.callbackQuery().data(), "/dogShelterOutRecommendations");
		assertEquals(sendDocument.getParameters().get("chat_id"), BTN_FROM_ID);
		assertNull(sendDocument.getParameters().get("text"));
