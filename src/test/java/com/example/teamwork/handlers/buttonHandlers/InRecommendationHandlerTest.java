...
class InRecommendationHandlerTest {

	@InjectMocks
	private InRecommendationHandler handler;
	@Mock
	...
	void createUpdate() {
		...
		updateCat = getUpdate(json, "/catShelterInRecommendations");
		updateDog = getUpdate(json, "/dogShelterInRecommendations");
	}
	...
	void realizationButtonCatTest() {
		...
		assertEquals(updateCat.callbackQuery().data(), "/catShelterInRecommendations");
	...
	void realizationButtonDogTest() {
		...
		assertEquals(updateDog.callbackQuery().data(), "/dogShelterInRecommendations");
		assertEquals(sendDocument.getParameters().get("chat_id"), BTN_FROM_ID);
		assertNull(sendDocument.getParameters().get("text"));
